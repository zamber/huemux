...
window.LightsyncShell = (() => {
  ...
  function titleFor(tab) {
    ...
    return 'lightsync — ' + LightsyncI18n.t(key);
  }
  ...
  function switchTab(tab) {
    ...
    if (tab !== active) {
      ...
      active = tab;
      const header = document.querySelector('lightsync-header');
  ...
  document.addEventListener('lightsync:langchange', () => { document.title = titleFor(active); });
